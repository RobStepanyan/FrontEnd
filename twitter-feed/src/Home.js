        ...
        <div id="left-bar" className="col">
            <div id="top">
                ...
                <div id="nav">
                    {nav.map((x, i) => {
                        return <a href="/">
                            <div className={"btn-icon-secondary" + (i === 0 ? ' active' : '')} >
                                <div className="icon">{x.svg}</div>
                    ...
                    <div className="my-4">
                        <div className="btn-icon-primary">
                            <div className="icon">
            ...
            <div id="bottom">
                <div className="btn-account">
                    <div className="d-inline-flex">
                        ...
                        <div className="px-3 hide">
                            <div className="semi-bold text-primary">Robert Stepanyan</div>
                            <div className="text-secondary">@RobertStepanya8</div>
                        </div>
                    </div>
                    <svg viewBox="0 0 24 24" className="hide"><g><circle cx="5" cy="12" r="2"></circle><circle cx="12" cy="12" r="2"></circle><circle cx="19" cy="12" r="2"></circle></g></svg>
                </div>
            </div>
        </div>
    )
...
function Feed() {
    return (
        <div id="feed" className="col">
            <div className="d-flex justify-content-space-between feed-section">
                <span className="h text-primary">Home</span>
                <div className="btn-icon border-0">
